...
void loop(){
  v1 = digitalRead(stick1);
  v2 = digitalRead(stick2);
  s1 = analogRead(switch1);
  s2 = analogRead(switch2);
 
  if(v1 == LOW && v2 == LOW){
    servo[1].write(map(s1, -300, 300, 0, 179));
    servo[2].write(map(s2, -300, 300, 0, 179));
   Serial.println("outputing to servos 1 and 2 "  );
 }
   else if(v1 == HIGH && v2 == LOW){
    servo[3].write(map(s1, -300, 300, 0, 179));
    servo[4].write(map(s2, -300, 300, 0, 179));
     Serial.println("outputing to servos 3 and 4 " );
  }  
  else if(v1 == LOW && v2 == HIGH){
   servo[5].write(map(s1, -300, 300, 0, 179));
   servo[6].write(map(s2, -300, 300, 0, 179));
    Serial.println("outputing to servos 5 and 6 " );
  }
  else if(v1 == HIGH && v2 == HIGH){
    servo[7].write(map(s1, -300, 300, 0, 179));
    servo[8].write(map(s2, -300, 300, 0, 179));
     Serial.println("outputing to servos 7 and 8 " );
  } 
}*/
