...
volatile unsigned long ANALOG[2] = {51, 49};
volatile unsigned long DIGITAL[2] = {47, 45};
...
void loop()
{
  ...
  Serial.print("  ");
  Serial.println(DigitalPulseTime[1]);
  
  if (DigitalPulseTime[0] < 1500 && DigitalPulseTime[1] < 1500 )
  {
    Out[0][0].writeMicroseconds(DigitalPulseTime[0]);
    Out[0][1].writeMicroseconds(DigitalPulseTime[1]);
  ...
  else if (DigitalPulseTime[0] > 1500 && DigitalPulseTime[1] < 1500 )
  {
    Out[1][0].writeMicroseconds(DigitalPulseTime[0]);
    Out[1][1].writeMicroseconds(DigitalPulseTime[1]);
  ...
  {
    Out[2][0].writeMicroseconds(DigitalPulseTime[0]);
    Out[2][1].writeMicroseconds(DigitalPulseTime[1]);
  ...
  {
    Out[3][0].writeMicroseconds(DigitalPulseTime[0]);
    Out[3][1].writeMicroseconds(DigitalPulseTime[1]);
